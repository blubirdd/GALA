...
public class DemoQuest2 : QuestNew
{
    ...
    void Start()
    {
        ...
        goalDescription[0] = "Photograph a Philippine Crocodile";
        requiredAmount[0] = 1;

        goalDescription[1] = "Cure a Tamaraw";
        requiredAmount[1] = 1;

        goalDescription[2] = "Photograph a Forest Turtle";
        requiredAmount[2] = 1;
        ...
        Goals.Add(new PictureGoal(this, "Philippine Crocodile", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
        Goals.Add(new UseGoal(this, "Medkit", goalDescription[1], false, currentProgress[1], requiredAmount[1]));
        Goals.Add(new PictureGoal(this, "Forest Turtle", goalDescription[2], false, currentProgress[2], requiredAmount[2]));
