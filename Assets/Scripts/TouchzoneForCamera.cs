...
public class TouchzoneForCamera : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    [System.Serializable]
    ...
    public float magnitudeMultiplier = 30;
    ...
    void Start()
    {
        ...
        //GameEvents.instance.onCameraClosed += SetCameraStateToClosed;
    ...
    IEnumerator SetSensitivity()
    {
        while (true)
        {
            yield return new WaitForSeconds(0.5f);
            magnitudeMultiplier = zoomInOut.zoomAmount;
        }
