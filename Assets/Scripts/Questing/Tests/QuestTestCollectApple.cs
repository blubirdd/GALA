...
public class QuestTestCollectApple : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTestCollectApple"; ;
        questName = "Grab an apple";
        questDescription = "Grab an apple";

        goalDescription[0] = "Grab the an apple";
        requiredAmount[0] = 5;
        ...
        Goals.Add(new CollectionGoal(this, "Apple", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
