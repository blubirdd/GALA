...
public class QuestTakeGalaQuiz : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTakeGalaQuiz"; ;
        questName = "Take and pass the last quiz";
        ...
        Goals.Add(new TalkGoal(this, "Gala Quiz", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
