...
public class QuestTakeSwampQuiz : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTakeSwampQuiz"; ;
        questName = "Take and pass the swamp quiz";
        ...
        Goals.Add(new TalkGoal(this, "Swamp Quiz", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
    ...
    IEnumerator IsQuestCompleted()
    {
        ...
        AcceptQuest("QuestGoToRainforest");
    }
}
