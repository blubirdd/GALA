...
public class QuestHeadToBeach : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestHeadToBeach"; ;
        questName = "Head to the beach";
        questDescription = "Find a way to beach";

        goalDescription[0] = "Find a way to beach";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Beach", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
    ...
    public void SpawnWaypointMarker()
    {
        ...
        _waypoint.GetComponent<WaypointUI>().SetTarget(WaypointManager.instance.waypointTransforms[18]);
