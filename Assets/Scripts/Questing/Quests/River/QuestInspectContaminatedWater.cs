...
public class QuestInspectContaminatedWater : QuestNew
{
    ...
    {
        //setup
        ID = "QuestInspectContaminatedWater"; ;
        questName = "Inspect the contaminated river";
        questDescription = "Inspect the contaminated river";

        goalDescription[0] = "Head to the river and inspect the water";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new CollectionGoal(this, "Contaminated Water", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
