...
public class QuestTalkSwampGuard : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkSwampGuard"; ;
        questName = "Talk to the guard inside.";
        questDescription = "Find and talk to the guard";

        goalDescription[0] = "Find and talk to the guard";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Swamp Guard", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
    ...
    public void SpawnWaypointMarker()
    {
        ...
        _waypoint.GetComponent<WaypointUI>().SetTarget(WaypointManager.instance.waypointTransforms[27]);
