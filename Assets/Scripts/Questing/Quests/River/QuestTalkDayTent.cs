...
public class QuestTalkDayTent : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkDayTent"; ;
        questName = "Rest in the camp until morning";
        questDescription = "Rest until morning";

        goalDescription[0] = "Rest until morning";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Day Tent", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
