...
public class QuestFindFarmer : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestFindFarmer"; ;
        questName = "Find and talk to the farmer";
        questDescription = "Talk to the farmer";

        goalDescription[0] = "Talk to the farmer";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Farmer", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
