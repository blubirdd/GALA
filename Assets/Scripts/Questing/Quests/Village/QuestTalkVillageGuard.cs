...
public class QuestTalkVillageGuard : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkVillageGuard"; ;
        questName = "Try to head out the village";
        questDescription = "Talk to the village guard";

        goalDescription[0] = "Talk to the village guard";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Village Guard", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
