...
public class QuestContainCrocodile : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestContainCrocodile"; ;
        questName = "Contain and capture the crocodiles";
        questDescription = "Use the net to capture  a crocodile";

        goalDescription[0] = "Grab a net";
        requiredAmount[0] = 1;

        goalDescription[1] = "Use the net to capture  a crocodile";
        requiredAmount[1] = 2;
        ...
        Goals.Add(new CollectionGoal(this, "Net", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
        Goals.Add(new TalkGoal(this, "Philippine Crocodile", goalDescription[1], false, currentProgress[1], requiredAmount[1]));
