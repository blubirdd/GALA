...
public class QuestTalkSwampWildlifeRanger2 : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkSwampWildlifeRanger2"; ;
        questName = "Report to Wildlife Ranger";
        questDescription = "Report to Wildlife Ranger";

        goalDescription[0] = "Report and talk to Wildlife Ranger";
        requiredAmount[0] = 1;
    ...
    IEnumerator IsQuestCompleted()
    {
        ...
        AcceptQuest("QuestEnterCrocSanctuary");
    }
}
