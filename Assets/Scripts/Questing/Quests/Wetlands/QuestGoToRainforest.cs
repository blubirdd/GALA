...
public class QuestGoToRainforest : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestGoToRainforest"; 
        questName = "Head to the rainforest";
        questDescription = "Find a way to the rainforest";

        goalDescription[0] = "Find a way to the rainforest";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Rainforest", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
    ...
    public void SpawnWaypointMarker()
    {
        ...
        _waypoint.GetComponent<WaypointUI>().SetTarget(WaypointManager.instance.waypointTransforms[24]);
