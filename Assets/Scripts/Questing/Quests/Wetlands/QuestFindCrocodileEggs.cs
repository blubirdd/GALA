...
public class QuestFindCrocodileEggs : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestFindCrocodileEggs"; ;
        questName = "Find crocodile eggs";
        questDescription = "Find crocodile eggs near bodies of water";

        goalDescription[0] = "Find crocodile eggs near bodies of water";
        requiredAmount[0] = 1;
