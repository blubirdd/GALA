...
public class QuestTalkSwampBiologist2 : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkSwampBiologist2"; ;
        questName = "Report back to Ars";
        questDescription = "Talk to the wildlife biologist";

        goalDescription[0] = "Talk to the wildlife biologist";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "SwampWildlifeBiologist", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
    ...
    public void SpawnWaypointMarker()
    {
        ...
        _waypoint.GetComponent<WaypointUI>().SetTarget(WaypointManager.instance.waypointTransforms[25]);
