...
public class QuestDisarmTraps : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestDisarmTraps"; ;
        questName = "Disarm hunter traps in the area";
        questDescription = "Find and disarm hunter traps in the area";


        goalDescription[0] = "Find and disarm hunter traps in the area";
        requiredAmount[0] = 3;
        ...
        Goals.Add(new TalkGoal(this, "Hunter Trap", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
