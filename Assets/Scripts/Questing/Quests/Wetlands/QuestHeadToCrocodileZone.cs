...
public class QuestHeadToCrocodileZone : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestHeadToCrocodileZone"; ;
        questName = "Head to the crocodile sanctuary";
        questDescription = "Enter the crocodile sanctuary";

        goalDescription[0] = "Find and talk to the people \nin the sanctuary";
        requiredAmount[0] = 2;
        ...
        Goals.Add(new TalkGoal(this, "Crocodile Sanctuary", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
