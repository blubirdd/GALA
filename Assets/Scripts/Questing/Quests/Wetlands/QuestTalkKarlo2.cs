...
public class QuestTalkKarlo2 : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkKarlo2"; ;
        questName = "Give the eggs to the sanctuary";
        questDescription = "Give the eggs to a biologist";

        goalDescription[0] = "Give the eggs to a biologist";
        requiredAmount[0] = 1;
    ...
    public void SpawnWaypointMarker()
    {
        ...
        _waypoint.GetComponent<WaypointUI>().SetTarget(WaypointManager.instance.waypointTransforms[26]);
