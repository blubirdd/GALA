...
public class QuestTalkSwampResident : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkSwampResident"; ;
        questName = "Swamp and Marshes Wetlands";
        questDescription = "Find out about the place";

        goalDescription[0] = "Talk to one of the residents";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "SwampResident", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
