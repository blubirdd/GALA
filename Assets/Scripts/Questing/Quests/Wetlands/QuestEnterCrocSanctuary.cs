...
public class QuestEnterCrocSanctuary : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestEnterCrocSanctuary"; ;
        questName = "Enter the Crocodile Sanctuary";
        questDescription = "Find and talk to Karlo";

        goalDescription[0] = "Find and talk to Karlo";
        requiredAmount[0] = 1;
