...
public class QuestRelocateCrocodile : QuestNew
{
    ...
    void Start()
    {
        ...
        goalDescription[0] = "Release the crocodiles in the wild";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Crocodile Wild", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
