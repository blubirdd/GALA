...
public class QuestPlayMoleGame : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestPlayMoleGame"; ;
        questName = "Enter the shelter and complete game";
        questDescription = "Play and complete the mini-game";

        goalDescription[0] = "Play and complete the mini-game";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Mole Game", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
