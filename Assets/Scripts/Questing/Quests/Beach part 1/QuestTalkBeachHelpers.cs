...
public class QuestTalkBeachHelpers : QuestNew
{
    ...
    {
        //setup
        ID = "QuestTalkBeachHelpers"; ;
        questName = "Find out about the Dugong";
        questDescription = "Talk to Lawrence";

        goalDescription[0] = "Talk to Lawrence";
        requiredAmount[0] = 1;

        goalDescription[1] = "Talk to Mon";
        requiredAmount[1] = 1;
        ...
        Goals.Add(new TalkGoal(this, "BeachLawrence", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
        Goals.Add(new TalkGoal(this, "Mon", goalDescription[1], false, currentProgress[1], requiredAmount[1]));
