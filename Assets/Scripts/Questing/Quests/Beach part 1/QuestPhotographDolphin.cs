...
public class QuestPhotographDolphin : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestPhotographDolphin"; ;
        questName = "Photograph a Dolphin";
        questDescription = "Take a photo of a dolphin";

        goalDescription[0] = "Take a photo of a dolphin";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new PictureGoal(this, "Bottlenose Dolphin", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
