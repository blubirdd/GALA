...
public class QuestTalkRainforestFairy2 : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkRainforestFairy2"; ;
        questName = "Report back to the fairy";
        questDescription = "Approach and report back \nto the fairy";

        goalDescription[0] = "Approach and report to \nthe fairy";
        requiredAmount[0] = 1;
