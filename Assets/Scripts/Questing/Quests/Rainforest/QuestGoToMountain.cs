...
public class QuestGoToMountain : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestGoToMountain"; ;
        questName = "Find a way up the mountain";
        questDescription = "Climb up the mountain";

        goalDescription[0] = "Climb up the mountain";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Mountain", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
    ...
    public void SpawnWaypointMarker()
    {
        ...
        _waypoint.GetComponent<WaypointUI>().SetTarget(WaypointManager.instance.waypointTransforms[29]);
