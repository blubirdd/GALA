...
public class QuestPhotographEagle : QuestNew
{
    ...
    void Start()
    {
        ...
        questDescription = "Find and photograph a Philippine Eagle";

        goalDescription[0] = "Find and photograph a Philippine Eagle";
        requiredAmount[0] = 3;
