...
public class QuestHeadBackToFairy : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestHeadBackToFairy"; ;
        questName = "Try to head back to the fairy";
        questDescription = "Head back to the fairy";

        goalDescription[0] = "Find and report back to the fairy";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Other Side", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
    ...
    public void SpawnWaypointMarker()
    {
        ...
        _waypoint.GetComponent<WaypointUI>().SetTarget(WaypointManager.instance.waypointTransforms[31]);
