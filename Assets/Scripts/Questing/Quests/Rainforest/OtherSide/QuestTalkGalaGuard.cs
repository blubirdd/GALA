...
public class QuestTalkGalaGuard : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkGalaGuard"; ;
        questName = "Talk to the guard";
        questDescription = "Talk to the guard";

        goalDescription[0] = "Approach and talk to the guard";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Gala Guard", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
    ...
    public void SpawnWaypointMarker()
    {
        ...
        _waypoint.GetComponent<WaypointUI>().SetTarget(WaypointManager.instance.waypointTransforms[32]);
