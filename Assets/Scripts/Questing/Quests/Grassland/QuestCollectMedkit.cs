...
public class QuestCollectMedkit : QuestNew
{
    private string[] goalDescription = new string[] { "Grab a medkit" };
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestCollectMedkit"; ;
        questName = "Grab a medkit";
        questDescription = "Grab a medkit";
        ...
        Goals.Add(new CollectionGoal(this, "Medkit", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
