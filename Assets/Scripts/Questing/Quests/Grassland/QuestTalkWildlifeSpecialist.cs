...
public class QuestTalkWildlifeSpecialist : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkWildlifeSpecialist"; ;
        questName = "Head to the camp site";
        questDescription = "Talk to the people in the camp";

        goalDescription[0] = "Talk to the people in the camp";
        requiredAmount[0] = 1;
