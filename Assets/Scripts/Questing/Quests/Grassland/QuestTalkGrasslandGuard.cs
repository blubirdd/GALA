...
public class QuestTalkGrasslandGuard : QuestNew
{   // Start is called before the first frame update
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkGrasslandGuard"; ;
        questName = "Try to head to the river";
        questDescription = "Talk to the grassland guard";

        goalDescription[0] = "Talk to the grassland guard";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Grassland Guard", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
