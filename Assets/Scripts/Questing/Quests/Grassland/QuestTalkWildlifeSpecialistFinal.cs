...
public class QuestTalkWildlifeSpecialistFinal : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkWildlifeSpecialistFinal"; ;
        questName = "Report back to the specialist";
        questDescription = "Talk to the specialist";

        goalDescription[0] = "Talk to the specialist about the tamaraw";
        requiredAmount[0] = 1;
