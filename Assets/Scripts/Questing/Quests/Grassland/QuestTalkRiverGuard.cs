...
public class QuestTalkRiverGuard : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkRiverGuard"; ;
        questName = "Try to cross the river";
        questDescription = "Talk to the river guard";

        goalDescription[0] = "Talk to the river guard";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "River Guard", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
    ...
    public void SpawnWaypointMarker()
    {
        ...
        _waypoint.GetComponent<WaypointUI>().SetTarget(WaypointManager.instance.waypointTransforms[19]);
