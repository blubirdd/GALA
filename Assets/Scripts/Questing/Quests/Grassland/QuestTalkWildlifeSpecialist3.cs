...
public class QuestTalkWildlifeSpecialist3 : QuestNew
{
    ...
    void Start()
    {
        ...
        //setup
        ID = "QuestTalkWildlifeSpecialist3"; ;
        questName = "Head back to the injured Tamaraw";
        questDescription = "Follow and talk to the wildlife specialist";

        goalDescription[0] = "Follow and talk to the wildlife specialist";
        requiredAmount[0] = 1;
        ...
        Goals.Add(new TalkGoal(this, "Wildlife Specialist2", goalDescription[0], false, currentProgress[0], requiredAmount[0]));
